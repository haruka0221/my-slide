...
## 作品傾向の実証的分析：対象文献と複合的アプローチ

### 分析対象文献の選定方針
- 20世紀後半以降の主要な文学批評理論・アプローチを代表する文献群。
    - **「『懐疑の解釈学』に基づく批評」**の重要な論考・批評集。
    - **「ポストクリティークとその関連アプローチ」**を代表する論考・批評集。

### 研究アプローチ
1.  **文献横断的な作品リスト構築:**
    選定文献の索引等から、言及されている文学作品を網羅的に抽出・データベース化。
2.  **作品群の特性分析（メタデータ）:**
    抽出作品のジャンル、発表年代、著者、主題等の傾向を統計的に分析し、各批評的潮流との関連を探る。
3.  **代表作品における「情報開示パターン」の定量的分析:**
    - テクスト内における言語的な新規性の度合いや、物語の構造的ダイナミクスを、情報科学的手法を用いて測定。
    - 各批評的潮流が参照する作品群において、これらの測定値が示す「情報開示パターン」に特徴的な傾向が見られるか検証。
