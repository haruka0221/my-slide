...
- **20世紀以降の文学批評の展開：アプローチの多様化**
    ...
    - 中でも、テクストの隠された意味や構造を読み解く**「『懐疑の解釈学』に基づく批評」**の大きな影響力

- **現代批評の新たな動きと本研究の関心**
    - 近年、「懐疑の解釈学」への問い直しと共に、**「ポストクリティークとその関連アプローチ」**（表層的読解、記述的アプローチ、修復的読解など）がテクストとの新たな関わり方を活発に模索。
    - **本研究の関心:** これら主要な批評的潮流が分析対象としてきた文学作品の種類、生み出してきた解釈、そして作品選択における傾向差の解明。

- **目的**
    - 主要な批評的潮流が参照する作品群の特性（特に「情報開示プロセス」）と作品選択の傾向を分析し、批評理論の特性理解を深める。
...
- **分析手法：** 上記要素を情報科学的手法を用いて定量化。
- **検証：** 各批評的潮流が参照する作品群で、測定値が示す「情報開示パターン」に特徴的な傾向が見られるか検証。
...
1.  **Piper, Xu, & Kolaczyk (2023) "Modeling Narrative Revelation" (CEUR Workshop Proceedings, 2023)**
