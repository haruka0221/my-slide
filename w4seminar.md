...
---
<!-- .slide: class="smaller" -->
## 本研究の方向性：批評アプローチの現状分析と新たな視点の模索

- **分析の対象**: 文学作品へのアプローチ方法としての批評理論とその実践
- **本研究の段階的目標**:
    - **第一段階**: 現代の多様な批評理論・アプローチの様相を整理し、その現在地を明確にする
    - **第二段階**: 各アプローチの前提、射程、および相互関係を考察し、主要な論点を抽出する
    - **その上で**: 文学研究に資する新たな分析視角や方法論の可能性を展望する
- **アプローチの基本姿勢**:
    - 批評理論の比較検討と歴史的文脈の再構成
...
## 20世紀批評理論の展開：多様性と「深層」への注視

- 20世紀を通じて、文学批評は目覚ましい理論的展開を遂げ、多様なアプローチが生まれた
    - （例：形式主義、構造主義、ポスト構造主義、精神分析批評、マルクス主義批評、フェミニズム批評、読者反応批評など）
- 各アプローチは、テクストの解釈に独自の光を当て、文学研究の領域を拡張
- 中でも、テクストの表層的意味の背後にある構造やイデオロギー、無意識などを読み解こうとする「深層」への注視（「症状的読解symptomatic reading」(E. Sedgwick)に代表される）は、影響力のある一つの傾向として認められる
...
## 現代批評の転換：「深層暴露型」からの多様なアプローチ
- 近年、従来の「深層暴露型」批評（症状的読解）への問い直しが顕著に
- **テクストとの新たな関わり方を模索するアプローチの台頭**:
    - **ポストクリティーク (R. Felski等)**:
...
## 批評アプローチの変遷：メタ視点からの探求

- 文学批評の歴史：アプローチの絶え間ない変遷と多様性の展開
- **本研究の視座**: この「アプローチの変遷プロセス自体」を客観的な研究対象として設定
- **探求のポイント**:
    - 各時代・各アプローチが「テクストに何を問い、どう読もうとしたか」の変容
    - その背景にある文学観や社会的要求の変化の考察
- → 理論史的整理に加え、具体的な批評実践やテクスト群の分析を通じたアプローチが有効
...
## 分析軸「情報開示」：批評的「読み」の変遷を探る指標

- 批評アプローチの具体的な変遷を捉えるための一つの分析軸として、
- **「テクストが情報を提示する戦略（＝情報開示プロセス）」の歴史的変化**に注目
- **着眼の根拠**:
    - 「情報開示」の仕方は、その時代の批評がテクストに何を期待し、どのような「読み」を価値あるものとしたか（例：「深層」の暴露か、「表面」の経験か）を反映する可能性が高い
- → **本研究では、この「情報開示パターン」の定量的分析を通じて、批評的「読み」の歴史的変遷の一端を実証的に照らし出すことを試みる**
